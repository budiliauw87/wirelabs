            ...
            <aside class="bg-base-100 min-h-screen w-80">
                ...
                <ul class="menu px-4 py-0">
                    ...
                    <li> <a class="group" href="/resources/videos/"><span><svg width="18" height="18"
                                    viewBox="0 0 48 48" class="w-5 h-5" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <li></li>
                    <li> <a class="group" href="/tailwindplay/" target="_blank"
                            rel="noopener noreferrer"><span><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                    ...
                    <li> <a class="group" href="/discord/" target="_blank" rel="noopener noreferrer"><span><svg
                                    class="h-5 w-5" x="0px" y="0px" width="16px" height="16px"
                                    viewBox="0 0 24 24">
